        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-2">
              {categories.map(category => <label key={category.value} className={`flex flex-col items-center p-2 rounded-md cursor-pointer transition-all ${formData.category === category.value ? darkMode ? 'bg-blue-600 text-white' : 'bg-blue-100 border-blue-500 border' : darkMode ? 'bg-gray-700 hover:bg-gray-600' : 'bg-gray-50 hover:bg-gray-100'}`}>
